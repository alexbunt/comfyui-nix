{
  ci.runtimeDepsNixpkgs = {
    ...
    hash = "sha256-2V9GZGvPfrNzxFozhI9dcqV+c3QdA8YZrvAAzqEB+dI=";
  };
  ...
  vendored = {
    # Intel macOS: avoid the broken Arrow C++ source build in nixpkgs 26.05.
    pyarrowDarwinX86_64 = {
      version = "25.0.1";
      url = "https://files.pythonhosted.org/packages/58/79/a0036dbe1eabe1f73127427342f1d99982584c4a2cde2651d6c93499c6f6/pyarrow-25.0.1-cp312-cp312-macosx_12_0_x86_64.whl";
      hash = "sha256-zEqkB/3p/GYL45OeSeox9Q8+n+wXwOxjFZ93Ee3T78k=";
    };
    av = {
      version = "18.1.0";
      linuxX86_64 = {
      ...
      darwinX86_64 = {
        url = "https://files.pythonhosted.org/packages/05/d4/d7cdc8bff143c17a6d35924375ae28dd692cacde38700a7d419fde54f44a/av-18.1.0-cp311-abi3-macosx_11_0_x86_64.whl";
        hash = "sha256-rnXYu2RniV7R+Fcu3t9/+knqwH9uSDIi9dfWKkHRLwQ=";
      };
    };
    torchcodec = {
      version = "0.16.0";
    ...
    gradioClient = {
      version = "2.6.1";
      url = "https://files.pythonhosted.org/packages/36/1b/e31b3776a4892fac8e2f980265a462f642df84bf488d5d667ef821a801af/gradio_client-2.6.1-py3-none-any.whl";
      hash = "sha256-3zdSkl+6qlb3v+6wBkriNZHsOXZDJEN0jdZjqXKe8js=";
    };

    gradio = {
      version = "6.26.0";
      url = "https://files.pythonhosted.org/packages/c6/06/6b708de7ca30f47ffb3a8f2d02173e6fa0cc6cf99442158f74b876338728/gradio-6.26.0-py3-none-any.whl";
      hash = "sha256-VMXEv+d4LhdzwrfXvhKANt+LDdbKMDwYatZEMoDhBjs=";
    };
